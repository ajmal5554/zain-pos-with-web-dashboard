...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-lg hover:shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900",
      className
    )}
    {...props}
  />
